      ...
      <div className=" hidden below-1100:block ">
        <div>
          ...
          <div className={`sidebar ${isOpen ? "open" : ""}`}>
            ...
            <div className="flex flex-col  justify-between  items-center mt-[10rem] w-full    ">
              <Link href="/">
                <button className="border-2 border-green-400/80 text-green-300 px-5 py-2 text-xs uppercase rounded transition-all duration-300 hover:bg-green-400 hover:text-black hover:border-green-400 hover:shadow-lg hover:shadow-green-400/50 shadow-md shadow-green-400/30 my-2 w-[10rem] text-[0.4rem]" style={{ boxShadow: '0 0 10px rgba(34, 197, 94, 0.5)' }} onClick={() => setIsOpen(false)}>Home</button>
              </Link>
              <Link href="/tech-stack">
