  ...
  return (
    <div className=" h-screen   overflow-auto   flex    ">
      <div className=" mt-12  w-full flex flex-col items-center  ">
        <h1 className="text-[6rem] uppercase below-1025:text-[4rem] below-635:text-[2rem]  below-500:mt-7 ">Projects</h1>
        <div className=" sectionBorder w-[80vw] ml-[12rem] below-635:mt-7 below-1100:ml-0  px-4   pl-7 ">
          <div className=" text-center uppercase mt-7">
            <h1 className=" text-[2rem] below-635:text-[1.5rem] below-426:text-[1.2rem]"> PurchasesPal Ecommerce</h1>
          </div>

          <h1 className=" my-4">
            {" "}
            <p className=" mt-2 below-426:text-[0.8rem]">5 May - 25 July 2024</p>
          </h1>
          <div className="  min-h-[5rem] ">
            <h1 className=" my-4 below-426:text-[0.8rem]"> Tech Stacks used :</h1>
            <div>
          ...
          <div className=" mt-4">
            <div className=" flex mt-4">
              <h1 className=" my-4 below-426:text-[0.8rem]"> Live Link:</h1>
              <Link href="https://www.purchasespal.shop/" target="_blank">
                <button className=" glow-button mx-2 my-2"> Live Link</button>
              </Link>
            </div>
            <div className=" flex  mt-4">
              <h1 className=" my-4 below-426:text-[0.8rem]"> Source Code:</h1>
              <Link
                href="https://github.com/amar1795/PROJECTS-"
                target="_blank"
              >
                <button className=" glow-button mx-2 my-2"> Source Link</button>
              </Link>
            </div>
          </div>
          <div className="     mt-5  mb-7 ">
            <h1 className=" text-[1.2rem]  mb-7 below-635:text-[1rem] below-426:text-[0.8rem]"> Description :</h1>
              <p className=" mt-4 below-635:text-[0.8rem]">
              {" "}
