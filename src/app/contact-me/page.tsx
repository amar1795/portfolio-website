    ...
    <div className="  h-screen  flex">
      <div className="terminals mt-12    w-full flex flex-col items-center overflow-auto">
        <div className="w-[90vw] max-w-6xl ml-[12rem] below-1100:ml-0 flex justify-center">
          <h1 className="text-[6rem] uppercase below-1445:text-[4rem] below-835:mt-[2rem] below-695:text-[2rem] below-500:text-[1.1rem] below-500:mt-[5rem] text-green-400">Contact Me</h1>
        </div>
        <div className=" sectionBorder below-695:mt-[2rem]   w-[80vw]   ml-[12rem] below-1100:ml-0  px-4  ">
          <div className=" mt-8 px-6  below-500:px-0   ">
            <h1 className="uppercase text-green-400 text-sm below-500:text-[0.6rem]"> You can Contact me on this Email </h1>
            <a href="mailto:your.jeetamar0038@gmail.com" className=" no-underline text-wrap text-green-300 text-sm below-500:text-[0.6rem]">jeetamar0038@gmail.com
            </a>
    
  
          </div>
          <div className=" mt-8 px-6 below-500:px-0">
            <h1 className="uppercase text-green-400 text-sm below-500:text-[0.6rem]">alternatively ! you can also reach out to me on my socials</h1>
          ...
          <div className=" mt-8 px-6 mb-7 uppercase below-500:px-0">
            <h1 className="text-green-400 text-sm below-500:text-[0.6rem]"> You can Find all my projects and work on my github :</h1>
